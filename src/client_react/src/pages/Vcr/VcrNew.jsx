...
export const VcrNew = () => {
  ...
  const add = (type, options) => {
    ...
    if (type === "snow" && customThis.rect) {
      const canvas = document.createElement("canvas");
      const ctx = canvas.getContext("2d");
      canvas.classList.add(type);
      canvas.width = customThis.rect.width / 2;
      canvas.height = customThis.rect.height / 2;
  ...
  useEffect(() => {
    ...
    console.log("inside updater useEffect", customThis.rect?.width);
    if (gui) {
